...
namespace BrunoMikoski.AnimationSequencer {
    ...
    public class CustomEasePropertyDrawer : PropertyDrawer {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
            ...
            var easeLabel = new GUIContent("Ease", "Controls the speed curve of the animation. " +
            ...
            var displayRect = EditorGUI.PrefixLabel(popupRect, easeLabel);
            var leftAlignedButton = EditorStyles.miniButton;

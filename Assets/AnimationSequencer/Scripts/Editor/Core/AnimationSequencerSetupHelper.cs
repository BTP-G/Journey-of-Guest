...
namespace BrunoMikoski.AnimationSequencer {
    ...
    public static class AnimationSequencerSetupHelper {
        ...
        static AnimationSequencerSetupHelper() {
            var availableAssemblies = CompilationPipeline.GetAssemblies(AssembliesType.PlayerWithoutTestAssemblies);

            var foundDOTween = false;
            for (var i = availableAssemblies.Length - 1; i >= 0; i--) {

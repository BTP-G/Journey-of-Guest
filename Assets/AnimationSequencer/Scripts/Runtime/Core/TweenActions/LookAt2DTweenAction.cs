...
namespace BrunoMikoski.AnimationSequencer {
    ...
    public sealed class LookAt2DTweenAction : TweenActionBase {
        ...
        protected override Tweener GenerateTween_Internal(GameObject target, float duration) {
            ...
            var tween = targetTransform.DORotate(CalculateRotation(), duration);
        ...
        private Vector3 CalculateRotation() {
            ...
            var direction = GetPosition() - (Vector2)targetTransform.position;
        ...
        private Vector2 GetPosition() {
            return toInputType switch {
                DataInputType.Vector => toPosition,
                DataInputType.Object => (Vector2)toTarget.position,

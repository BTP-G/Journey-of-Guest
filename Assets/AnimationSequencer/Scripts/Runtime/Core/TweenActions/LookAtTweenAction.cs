...
namespace BrunoMikoski.AnimationSequencer {
    ...
    public sealed class LookAtTweenAction : TweenActionBase {
        ...
        protected override Tweener GenerateTween_Internal(GameObject target, float duration) {
            ...
            var tween = targetTransform.DOLookAt(GetPosition(), duration, axisConstraint, VectorDirectionUtility.GetDirectionVector(up));
        ...
        private Vector3 GetPosition() {
            return toInputType switch {
                ...
                DataInputType.Object => toTarget.position,
                _ => Vector3.zero,
            };
        }

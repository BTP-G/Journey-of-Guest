...
namespace RealToon.GUIInspector {
    ...
    public class RealToonShaderGUI_URP_SRP : ShaderGUI {
        ...
        //MainCamera Color in Ambient Light Only [5]
        ...
        //Mix MainCamera Texture To Outline [33] [Outline]
        ...
        //Outline Width Affected By _view Distance [37] [Outline]
        ...
        //Texture and MainCamera Color Intensity [43] [SelfLit]
        ...
        //Follow UObject Rotation [56] [Gloss Texture]
        ...
        //Self Shadow & ShadowT At _view Direction [60]
        ...
        //Smooth UObject Normal [71]
        "The amount of smooth object normal." ,

        //Vertex Color Red Control Smooth UObject Normal [72]
        "'Vertex color Red controls the amount of smooth object normal." ,

        //XYZ Position [73] [Smooth UObject Normal]
        "Normal's XYZ positions." ,

        //Affect Shadow [74]
        "Transparency affect shadow." ,

        //Show Normal [75] [Smooth UObject Normal]
        ...
        //Follow UObject Rotation [100] [Custom Light Direction]
        ...
        //Remove Outline/Enqueue Outline (On Shader) [135]
        ...
        //OnClose-Up PreCheckedSize (Perspective Adjustment) [159]
        "This will adjust the size of the object when the camera is closer.",

        //OnClose-Up PreCheckedSize Smooth Transition (Perspective Adjustment) [160]
        "How smooth the transition of the sizing.",

        //OnClose-Up PreCheckedSize Distance (Perspective Adjustment) [161]
        "Distance transition from the camera to the object.",

        //SDF Mode (ShadowT) [162]
        "SDF Style Shadowing.\nNote: This only affect 3D Space X & Z axis.",

        //Enqueue/Remove 'See Through' feature [163]

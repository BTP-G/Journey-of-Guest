...
namespace GAP_ParticleSystemController {
    ...
    public class ParticleSystemController : MonoBehaviour {
        ...
        public Color ChangeHUE(Color oldColor, Color newColor) {
            ...
            Color.RGBToHSV(newColor, out var newHue, out var newSaturation, out var newValue);
            Color.RGBToHSV(oldColor, out var oldHue, out var oldSaturation, out var oldValue);

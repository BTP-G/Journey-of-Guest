...
public class SpawnMagicAbilityScript : MonoBehaviour {
    ...
    public void SpawnVFX() {
        ...
        var vfxSpawned = Instantiate(effectToSpawn);
    ...
    private IEnumerator ShakeDelay(List<float> delay) {
    ...
    private void CleanSpawnedVFXList() {
        for (var i = 0; i < spawnedVFX.Count; i++) {

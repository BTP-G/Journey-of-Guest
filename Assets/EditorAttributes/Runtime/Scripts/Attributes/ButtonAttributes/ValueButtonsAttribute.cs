...
namespace EditorAttributes {
    ...
    public class ValueButtonsAttribute : PropertyAttribute, IDisplayNamesAttribute {
        ...
        /// <param name="buttonsHeight">The height of the selection buttons in pixels</param>
        /// <param name="showLabel">Show the label of the field</param>
        public ValueButtonsAttribute(string collectionName, string[] displayNames, float buttonsHeight = 18f, bool showLabel = true) : this(collectionName, buttonsHeight, showLabel) {

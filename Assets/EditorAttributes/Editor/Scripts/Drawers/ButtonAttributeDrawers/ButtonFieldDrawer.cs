    ...
    public class ButtonFieldDrawer : PropertyDrawerBase {
        public override VisualElement CreatePropertyGUI(SerializedProperty property) {
            ...
            if (path.Length == 1) {
                ...
                var type = ReflectionUtils.GetNestedObjectType(property, out ownerObject);
            ...
            var function = ReflectionUtils.FindFunction(buttonFieldAttribute.FunctionName, ownerObject);

...
namespace ANU.IngameDebug.Console {
    internal class LogsContainer {
        ...
        public void Filter(string search = null, LogType[] types = null) {
            if (string.IsNullOrEmpty(SearchString) && string.IsNullOrEmpty(search)
                && (types == FilterTypes
                    || (types != null && FilterTypes != null && types.Length == FilterTypes.Count && types.Zip(FilterTypes, (a, b) => new { a, b }).All(b => b.a == b.b)))
                ) {
                return;
            }
        ...
        private bool IsMatchFilters(Log log) {
            return (FilterTypes == null || log.ConsoleLogtype != ConsoleLogType.AppMessage || FilterTypes.Contains(log.MessageType))
    ...
    internal struct LogNode {
        ...
        public override bool Equals(object obj) {
            return obj is LogNode node && this == node;
        }

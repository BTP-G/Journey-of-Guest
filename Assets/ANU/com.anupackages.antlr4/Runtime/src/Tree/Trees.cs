...
namespace Antlr4.Runtime.Tree {
    ...
    public class Trees {
        ...
        public static string GetNodeText(ITree t, IList<string> ruleNames) {
            if (ruleNames != null) {
                if (t is RuleContext) {
                    var ruleIndex = ((RuleContext)t).RuleIndex;
                    var ruleName = ruleNames[ruleIndex];
                    var altNumber = ((RuleContext)t).getAltNumber();

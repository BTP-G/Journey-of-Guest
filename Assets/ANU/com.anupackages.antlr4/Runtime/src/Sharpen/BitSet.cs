...
namespace Antlr4.Runtime.Sharpen {
    public class BitSet {
        ...
        public BitSet(int nbits) {
            ...
            if (nbits > 0) {
                var length = (nbits + BitsPerElement - 1) / BitsPerElement;
        ...
        public void Clear(int index) {
            ...
            var element = index / BitsPerElement;
        ...
        public int NextSetBit(int fromIndex) {
            ...
            var i = fromIndex / BitsPerElement;
            if (i >= _data.Length) {
                return -1;
            }

            var current = _data[i] & ~((1UL << (fromIndex % BitsPerElement)) - 1);

            while (true) {
                var bit = BitScanForward(current);
                if (bit >= 0) {
        ...
        public void And(BitSet set) {
            ...
            var length = Math.Min(_data.Length, set._data.Length);

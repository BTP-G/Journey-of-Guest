...
namespace Antlr4.Runtime.Misc {
    ...
    public struct Interval {
        ...
        public override bool Equals(object o) {
            if (o is not Interval) {
                return false;
            }

            var other = (Antlr4.Runtime.Misc.Interval)o;
        ...
        public Antlr4.Runtime.Misc.Interval? DifferenceNotProperlyContained(Antlr4.Runtime.Misc.Interval other) {
            ...
            if (other.StartsBeforeNonDisjoint(this)) {
                diff = Antlr4.Runtime.Misc.Interval.Of(Math.Max(a, other.b + 1), b);
            } else {
                // other.a to right of this.a
                if (other.StartsAfterNonDisjoint(this)) {
                    diff = Antlr4.Runtime.Misc.Interval.Of(a, other.a - 1);
                }
            }
            return diff;
        }

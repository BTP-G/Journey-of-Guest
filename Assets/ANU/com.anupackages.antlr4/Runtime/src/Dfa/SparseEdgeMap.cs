    ...
    public sealed class SparseEdgeMap<T> : AbstractEdgeMap<T>
        ...
        public override T this[int key] {
            get {
                ...
                var index = System.Array.BinarySearch(keys, 0, Count, key);
                if (index < 0) {
                    return null;
                }
                return values[index];
        ...
        public override AbstractEdgeMap<T> Put(int key, T value) {
            ...
            lock (this) {
                ...
                var desiredSize = Count >= MaxSparseSize ? MaxSparseSize * 2 : MaxSparseSize;
                var space = maxIndex - minIndex + 1;
                ...
                if (desiredSize >= space / 2) {
                    ...
                    var resized = new Antlr4.Runtime.Dfa.SparseEdgeMap<T>(this, desiredSize);
        ...
        public override AbstractEdgeMap<T> Remove(int key) {
            lock (this) {
                ...
                var result = new Antlr4.Runtime.Dfa.SparseEdgeMap<T>(this, MaxSparseSize);

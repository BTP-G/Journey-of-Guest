...
[assembly: RegisterDebugCommandTypes(typeof(ExpressionEvaluatorPreprocessor))]
...
namespace ANU.IngameDebug.Console {
    public class ExpressionEvaluatorPreprocessor : ICommandInputPreprocessor {
        ...
        private static void InitStatic() {
            DebugConsole.Preprocessors.Add(new ExpressionEvaluatorPreprocessor());
        }
        ...
        public string Preprocess(string input) {
            ...
            var evaluatedArgs = cmdLine.Select(a => {
                ...
                if (a.StartsWith("-")) {
                    ...
                    var option = a[..indOfEq];
                    var value = a[(indOfEq + 1)..].Trim('"').Trim('\'');
        ...
        private static object EvaluateAlias(string expression) {

...
namespace ImpossibleRobert.Common {
    ...
    public static class CommonUIStyles {
        ...
        public static GUIStyle miniLabelRight {
            get { return _miniLabelRight ??= new GUIStyle(EditorStyles.miniLabel) { alignment = TextAnchor.MiddleRight }; }
        }
        ...
        static CommonUIStyles() {
            ...
            var prop = clipType.GetProperty("visibleRect", BindingFlags.Static | BindingFlags.NonPublic);
            var getter = prop.GetGetMethod(true);
            getVisibleRect = (Func<Rect>)Delegate.CreateDelegate(typeof(Func<Rect>), getter);
        }

        public static Rect GetCurrentVisibleRect() {
        ...
        private static void CreateMainButton() {
            var baseCol = EditorGUIUtility.isProSkin ? new Color(0.20f, 0.48f, 0.95f) : new Color(0.16f, 0.44f, 0.93f);
            var hoverCol = Color.Lerp(baseCol, Color.white, 0.15f);
            var activeCol = Color.Lerp(baseCol, Color.black, 0.20f);
        ...
        public static Texture2D LoadTexture(string name) {
            var asset = AssetDatabase.FindAssets("t:Texture2d " + name).FirstOrDefault();
        ...
        public static GUIStyle whiteCenter {
            get { return _whiteCenter ??= new GUIStyle { alignment = TextAnchor.MiddleCenter, normal = new GUIStyleState { textColor = Color.white } }; }
        }
        private static GUIStyle _blackCenter;
        public static GUIStyle blackCenter {
            get { return _blackCenter ??= new GUIStyle { alignment = TextAnchor.MiddleCenter, normal = new GUIStyleState { textColor = Color.black } }; }
        }
        private static GUIStyle _centerLabel;
        public static GUIStyle centerLabel {
            get { return _centerLabel ??= new GUIStyle(GUI.skin.label) { alignment = TextAnchor.MiddleCenter }; }
        }

        private static GUIStyle _centerHeading;
        public static GUIStyle centerHeading {
            get { return _centerHeading ??= new GUIStyle(GUI.skin.label) { alignment = TextAnchor.MiddleCenter, fontSize = 20, fontStyle = FontStyle.Bold }; }
        }
        private static GUIStyle _centeredWhiteMiniLabel;
        public static GUIStyle centeredWhiteMiniLabel {
            get { return _centeredWhiteMiniLabel ??= new GUIStyle(EditorStyles.centeredGreyMiniLabel) { normal = new GUIStyleState { textColor = Color.white } }; }
        }

        private static GUIStyle _centeredGreyWrappedMiniLabel;
        public static GUIStyle centeredGreyWrappedMiniLabel {
            get { return _centeredGreyWrappedMiniLabel ??= new GUIStyle(EditorStyles.centeredGreyMiniLabel) { wordWrap = true }; }
        }

        private static GUIStyle _rightLabel;
        public static GUIStyle rightLabel {
            get { return _rightLabel ??= new GUIStyle(GUI.skin.label) { alignment = TextAnchor.MiddleRight }; }
        }

        private static GUIStyle _centerLinkLabel;
        public static GUIStyle centerLinkLabel {
            get { return _centerLinkLabel ??= new GUIStyle(EditorStyles.linkLabel) { alignment = TextAnchor.MiddleCenter }; }
        }

        private static GUIStyle _centerPopup;
        public static GUIStyle centerPopup {
            get { return _centerPopup ??= new GUIStyle(EditorStyles.popup) { alignment = TextAnchor.MiddleCenter }; }
        }
        ...
        public static GUIStyle ColoredText(Color color, bool wrapped = false) {
            var style = new GUIStyle(wrapped ? EditorStyles.wordWrappedLabel : EditorStyles.label);
        ...
        public static GUIContent IconContent(string name, string darkName, string tooltip = null) {
            if (EditorGUIUtility.isProSkin) {
                return EditorGUIUtility.IconContent(darkName, tooltip);
            }

...
namespace UnityEngine.Events {
    [Serializable]
    public class ArgumentCache2 : ISerializationCallbackReceiver {
        [SerializeField]
        ...
        [SerializeField]
        private bool m_IsDynamicArgument = false;
        [SerializeField]
        ...
        [SerializeField]
        private List<DynamicArgumentCache2> m_Arguments = new List<DynamicArgumentCache2>();
        [SerializeField]
        ...
        public string unityObjectArgumentAssemblyTypeName {
            ...
            set { m_ObjectArgumentAssemblyTypeName = value; }
        }
        ...
        public bool isDynamic {
            get { return m_IsDynamicArgument; }
        }

        public bool dynamicIsStatic {
        ...
        public bool dynamicIsStaticForInstance {
        ...
        public List<DynamicArgumentCache2> dynamicArguments {
            get { return m_Arguments; }
        }

        public List<PersistentListenerMode2> dynamicModes {
            get { return m_Modes; }
        }
        ...
        private void TidyAssemblyTypeName() {
            ...
            var val1_1 = m_ObjectArgumentAssemblyTypeName.IndexOf(", Version=");
            if (val1_1 != -1) {
                num = Math.Min(val1_1, num);
            }

            var val1_2 = m_ObjectArgumentAssemblyTypeName.IndexOf(", Culture=");
            if (val1_2 != -1) {
                num = Math.Min(val1_2, num);
            }

            var val1_3 = m_ObjectArgumentAssemblyTypeName.IndexOf(", PublicKeyToken=");
            if (val1_3 != -1) {
            ...
            m_ObjectArgumentAssemblyTypeName = m_ObjectArgumentAssemblyTypeName[..num];

            var val1_4 = m_ObjectArgumentAssemblyTypeName.IndexOf("[[");
            if (val1_4 != -1) {

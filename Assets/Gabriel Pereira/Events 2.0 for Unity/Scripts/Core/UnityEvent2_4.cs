...
namespace UnityEngine.Events {
    ...
    public abstract class UnityEvent2<T0, T1, T2, T3> : UnityEventBase2 {
        ...
        protected override MethodInfo FindMethod_Impl(object targetObj, string name, bool isStatic) {
            return GetValidMethodInfo(targetObj, name, new System.Type[4] { typeof(T0), typeof(T1), typeof(T2), typeof(T3) }, isStatic);
        }
        ...
        public void Invoke(T0 arg1, T1 arg2, T2 arg3, T3 arg4) {
            var calls = PrepareInvoke(arg1, arg2, arg3, arg4);
            for (var i = 0; i < calls.Count; i++) {
                if (calls[i] is InvokableCall2<T0, T1, T2, T3> curCall) {

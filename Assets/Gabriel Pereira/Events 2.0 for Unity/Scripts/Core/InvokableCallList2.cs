...
namespace UnityEngine.Events {
    internal class InvokableCallList2 {
        ...
        public void RemoveListener(object targetObj, MethodInfo method) {
            var baseInvokableCallList = new List<BaseInvokableCall2>();
            for (var index = 0; index < m_RuntimeCalls.Count; ++index) {
        ...
        public void Invoke(object[] parameters) {
            ...
            for (var index = 0; index < m_ExecutingCalls.Count; ++index) {

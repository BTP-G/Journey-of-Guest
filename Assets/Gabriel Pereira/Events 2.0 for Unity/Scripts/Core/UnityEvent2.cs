...
namespace UnityEngine.Events {
    ...
    public abstract class UnityEventBase2 : ISerializationCallbackReceiver {
        ...
        internal MethodInfo FindMethod(object listener, string name, PersistentListenerMode2 mode, Type argumentType, bool isStatic) {
            return mode switch {
                PersistentListenerMode2.EventDefined => FindMethod_Impl(listener, name, isStatic),
                PersistentListenerMode2.Void => GetValidMethodInfo(listener, name, new Type[0], isStatic),
                PersistentListenerMode2.Object => GetValidMethodInfo(listener, name, new Type[1] { argumentType ?? typeof(Object) }, isStatic),
                PersistentListenerMode2.Char => GetValidMethodInfo(listener, name, new Type[1] { typeof(char) }, isStatic),
                PersistentListenerMode2.Byte => GetValidMethodInfo(listener, name, new Type[1] { typeof(byte) }, isStatic),
                PersistentListenerMode2.SByte => GetValidMethodInfo(listener, name, new Type[1] { typeof(sbyte) }, isStatic),
                PersistentListenerMode2.Short => GetValidMethodInfo(listener, name, new Type[1] { typeof(short) }, isStatic),
                PersistentListenerMode2.UShort => GetValidMethodInfo(listener, name, new Type[1] { typeof(ushort) }, isStatic),
                PersistentListenerMode2.Int => GetValidMethodInfo(listener, name, new Type[1] { typeof(int) }, isStatic),
                PersistentListenerMode2.UInt => GetValidMethodInfo(listener, name, new Type[1] { typeof(uint) }, isStatic),
                PersistentListenerMode2.Long => GetValidMethodInfo(listener, name, new Type[1] { typeof(long) }, isStatic),
                PersistentListenerMode2.Float => GetValidMethodInfo(listener, name, new Type[1] { typeof(float) }, isStatic),
                PersistentListenerMode2.Double => GetValidMethodInfo(listener, name, new Type[1] { typeof(double) }, isStatic),
                PersistentListenerMode2.String => GetValidMethodInfo(listener, name, new Type[1] { typeof(string) }, isStatic),
                PersistentListenerMode2.Bool => GetValidMethodInfo(listener, name, new Type[1] { typeof(bool) }, isStatic),
                PersistentListenerMode2.Enum => GetValidMethodInfo(listener, name, new Type[1] { typeof(Enum) }, isStatic),
                _ => null,
            };
        }
        ...
        protected void Invoke(object[] parameters) {
            var calls = PrepareInvoke(parameters);
        ...
        protected bool ValidateRegistration(MethodInfo method, object targetObj, PersistentListenerMode2 mode, Type argumentType) {
            ...
            var @object = targetObj as Object;
        ...
        internal void AddVoidPersistentListener(UnityAction call) {
            var persistentEventCount = GetPersistentEventCount();

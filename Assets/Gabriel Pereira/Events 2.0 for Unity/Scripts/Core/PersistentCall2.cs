...
namespace UnityEngine.Events {
    ...
    public class PersistentCall2 {
        ...
        private BaseInvokableCall2 GetInvokableCall(Type firstType, object firstValue, MethodInfo method, List<PersistentListenerMode2> modes, ArgumentCache2[] arguments, object[] informedParameters) {
            ...
            var types = new Type[arguments.Length + 4];
            var parameters = new object[arguments.Length + 4];
            var persistentCalls2 = new PersistentCall2[arguments.Length];
            ...
            var constructor = invokableType.MakeGenericType(typeArguments).GetConstructor(types);
        ...
        public object GetValue(Type type, ArgumentCache2 argument) {
            if (type == typeof(char)) {
                ...
                if (type == typeof(char[])) {
                    ...
                    for (var i = 0; i < argument.intArrayArgument.Count; i++) {
                    ...
                    for (var i = 0; i < argument.unityObjectArrayArgument.Count; i++) {

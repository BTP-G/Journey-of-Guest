...
namespace UnityEngine.UI.CoroutineTween {
    ...
    internal interface ITweenValue2 {
    ...
    internal struct ColorTween2 : ITweenValue2 {
    ...
    // TweenValue callback and then sets
    // the value on the target.
    internal struct FloatTween2 : ITweenValue2 {
    ...
    // behaviour container.
    internal class TweenRunner2<T> where T : struct, ITweenValue2 {

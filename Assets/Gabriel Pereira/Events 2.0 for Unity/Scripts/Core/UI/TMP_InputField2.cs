...
namespace TMPro
{
	...
	/// </summary>
	[AddComponentMenu("UI/TextMeshPro - Input Field 2.0", 11)]
	public class TMP_InputField2 : Selectable,
		...
		IScrollHandler
	{
		...
		[Serializable]
		public class SubmitEvent : UnityEvent2<string> { }

		[Serializable]
		public class OnChangeEvent : UnityEvent2<string> { }

		[Serializable]
		public class SelectionEvent : UnityEvent2<string> { }

		[Serializable]
		public class TextSelectionEvent : UnityEvent2<string, int, int> { }

		[Serializable]
		public class TouchScreenKeyboardEvent : UnityEvent2<TouchScreenKeyboard.Status> { }

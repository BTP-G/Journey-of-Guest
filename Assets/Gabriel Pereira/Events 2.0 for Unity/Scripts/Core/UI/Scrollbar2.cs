...
namespace UnityEngine.UI {
    ...
    public class Scrollbar2 : Selectable, IBeginDragHandler, IDragHandler, IInitializePotentialDragHandler, ICanvasElement {
        ...
        private Axis axis { get { return (m_Direction is Scrollbar.Direction.LeftToRight or Scrollbar.Direction.RightToLeft) ? Axis.Horizontal : Axis.Vertical; } }
        private bool reverseValue { get { return m_Direction is Scrollbar.Direction.RightToLeft or Scrollbar.Direction.TopToBottom; } }
        ...
        private void UpdateDrag(PointerEventData eventData) {
            ...
            if (!RectTransformUtility.ScreenPointToLocalPointInRectangle(m_ContainerRect, eventData.position, eventData.pressEventCamera, out var localCursor)) {
                return;
            }
            ...
            var parentSize = axis == 0 ? m_ContainerRect.rect.width : m_ContainerRect.rect.height;
            var remainingSize = parentSize * (1 - size);
            if (remainingSize <= 0) {
                return;
            }
        ...
        public virtual void OnBeginDrag(PointerEventData eventData) {
            ...
            if (RectTransformUtility.RectangleContainsScreenPoint(m_HandleRect, eventData.position, eventData.enterEventCamera)) {
                if (RectTransformUtility.ScreenPointToLocalPointInRectangle(m_HandleRect, eventData.position, eventData.pressEventCamera, out var localMousePos)) {

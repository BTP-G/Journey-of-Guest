    ...
    public class EventTrigger2Editor : Editor {
        ...
        protected virtual void OnEnable() {
            ...
            m_IconToolbarMinus = new GUIContent(EditorGUIUtility.IconContent("Toolbar Minus")) {
                tooltip = "Remove this event handler."
            };

            var names = Enum.GetNames(typeof(EventTriggerType));
        ...
        public override void OnInspectorGUI() {
            ...
            var vector2 = GUIStyle.none.CalcSize(m_IconToolbarMinus);

            for (var index = 0; index < m_DelegatesProperty.arraySize; ++index) {
                var arrayElementAtIndex = m_DelegatesProperty.GetArrayElementAtIndex(index);

                var eventIDProp = arrayElementAtIndex.FindPropertyRelative("eventID");
                var callbackProp = arrayElementAtIndex.FindPropertyRelative("callback");
            ...
            var rect = GUILayoutUtility.GetRect(m_AddButtonContent, GUI.skin.button);
            rect.x += (rect.width - 200.0f) / 2.0f;
            rect.width = 200f;
        ...
        private void ShowAddTriggerMenu() {
            ...
            for (var index1 = 0; index1 < m_EventTypes.Length; ++index1) {
                var flag = true;
                for (var index2 = 0; index2 < m_DelegatesProperty.arraySize; ++index2) {

...
namespace TMPro.EditorUtilities {
    ...
    public static class TMP_EditorUtility2 {
        /// <summary>
        ...
        public static Material[] FindMaterialReferences(TMP_FontAsset fontAsset) {
            ...
            var searchPattern = "t:Material" + " " + fontAsset.name.Split(new char[] { ' ' })[0];
        ...
        public static TMP_FontAsset FindMatchingFontAsset(Material mat) {
            ...
            var dependentAssets = AssetDatabase.GetDependencies(AssetDatabase.GetAssetPath(mat), false);

            for (var i = 0; i < dependentAssets.Length; i++) {
                var fontAsset = AssetDatabase.LoadAssetAtPath<TMP_FontAsset>(dependentAssets[i]);
                if (fontAsset != null) {
                    return fontAsset;
                }
            }
        ...
        private static string GetPackageRelativePath() {
            ...
            if (Directory.Exists(packagePath)) {
                ...
                var matchingPaths = Directory.GetDirectories(packagePath, "TextMesh Pro", SearchOption.AllDirectories);
        ...
        public static string GetDecimalCharacterSequence(int[] characterSet) {
            ...
            var characterSequence = string.Empty;
            var count = characterSet.Length;
            var first = characterSet[0];
            var last = first;

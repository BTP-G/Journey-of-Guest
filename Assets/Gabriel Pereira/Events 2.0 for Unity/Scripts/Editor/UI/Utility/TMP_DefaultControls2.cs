...
namespace TMPro
{
    ...
    public static class TMP_DefaultControls2
    {
        ...
        {
            GameObject buttonRoot = CreateUIElementRoot("Button 2.0 (TMP)", s_ThickElementSize);
        ...
        {
            GameObject root = CreateUIElementRoot("InputField 2.0 (TMP)", s_ThickElementSize);
            ...
            TMP_InputField2 inputField = root.AddComponent<TMP_InputField2>();
        ...
        {
            GameObject root = CreateUIElementRoot("Dropdown 2.0 (TMP)", s_ThickElementSize);
            ...
            TMP_Dropdown2 dropdown = root.AddComponent<TMP_Dropdown2>();
            ...
            dropdown.options.Add(new TMP_Dropdown2.OptionData {text = "Option A" });
            dropdown.options.Add(new TMP_Dropdown2.OptionData {text = "Option B" });
            dropdown.options.Add(new TMP_Dropdown2.OptionData {text = "Option C" });

...
namespace TMPro.EditorUtilities
{
    ...
    [CustomEditor(typeof(TMP_InputField2), true)]
    public class TMP_InputField2Editor : SelectableEditor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            m_foldout.fontSettings = EditorGUILayout.Foldout(m_foldout.fontSettings, "Input Field Settings", true, TMP_UIStyleManager2.boldFoldout);
            ...
            m_foldout.extraSettings = EditorGUILayout.Foldout(m_foldout.extraSettings, "Control Settings", true, TMP_UIStyleManager2.boldFoldout);

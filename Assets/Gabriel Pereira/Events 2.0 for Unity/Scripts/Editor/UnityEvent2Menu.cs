...
namespace UnityEditor.UI {
    [InitializeOnLoad]
    internal static class UnityEvent2Menu {
        private static DefaultControls.Resources s_StandardResources;

#if TEXTMESHPRO
		private static TMP_DefaultControls2.Resources s_TMPStandardResources;
#endif
...
#if TEXTMESHPRO
		private static TMP_DefaultControls2.Resources GetTMPStandardResources()
		{
...
#if TEXTMESHPRO
		[MenuItem("GameObject/UI/Button 2.0 - TextMeshPro", false, 2031)]
		public static void AddButtonWithTextMeshPro(MenuCommand menuCommand)
		{
			GameObject go = TMP_DefaultControls2.CreateButton(GetTMPStandardResources());
        ...
        public static void AddDropdown(MenuCommand menuCommand) {
            var go = CreateDropdown(GetStandardResources());
            PlaceUIElementRoot(go, menuCommand);
        }

#if TEXTMESHPRO
		[MenuItem("GameObject/UI/Dropdown 2.0 - TextMeshPro", false, 2036)]
		public static void AddDropdownWithTexMeshPro(MenuCommand menuCommand)
		{
			GameObject go = TMP_DefaultControls2.CreateDropdown(GetTMPStandardResources());

			PlaceUIElementRoot(go, menuCommand);
		}
#endif

        [MenuItem("GameObject/UI/Input Field 2.0", false, 2038)]
        public static void AddInputField(MenuCommand menuCommand) {
            var go = CreateInputField(GetStandardResources());
            PlaceUIElementRoot(go, menuCommand);
        }

#if TEXTMESHPRO
		[MenuItem("GameObject/UI/Input Field 2.0 - TextMeshPro", false, 2038)]
		public static void AddInputFieldWithTexMeshPro(MenuCommand menuCommand)
		{
			GameObject go = TMP_DefaultControls2.CreateInputField(GetTMPStandardResources());
        ...
        public static void AddScrollView(MenuCommand menuCommand) {
            var go = CreateScrollView(GetStandardResources());
            PlaceUIElementRoot(go, menuCommand);
        }
            ...
            if (parent != menuCommand.context) // not a context click, so center in sceneview
{
...
#if UNITY_2021_3_OR_NEWER && !UNITY_2022_1
        ...
        private static GameObject CreateButton(DefaultControls.Resources resources) {
            var buttonRoot = CreateUIElementRoot("Button 2.0", s_ThickElementSize);
            ...
            var bt = buttonRoot.AddComponent<Button2>();
        ...
        private static GameObject CreateToggle(DefaultControls.Resources resources) {
            // Set up hierarchy
            var toggleRoot = CreateUIElementRoot("Toggle 2.0", s_ThinElementSize);

            var background = CreateUIObject("Background", toggleRoot);
            var checkmark = CreateUIObject("Checkmark", background);
            var childLabel = CreateUIObject("Label", toggleRoot);

            // Set up components
            var toggle = toggleRoot.AddComponent<Toggle2>();
            toggle.isOn = true;
            ...
            var label = childLabel.AddComponent<Text>();
        ...
        private static GameObject CreateSlider(DefaultControls.Resources resources) {
            ...
            var root = CreateUIElementRoot("Slider 2.0", s_ThinElementSize);
            ...
            var slider = root.AddComponent<Slider2>();
        ...
        private static GameObject CreateScrollbar(DefaultControls.Resources resources) {
            // Create GOs Hierarchy
            var scrollbarRoot = CreateUIElementRoot("Scrollbar 2.0", s_ThinElementSize);
            ...
            var scrollbar = scrollbarRoot.AddComponent<Scrollbar2>();
        ...
        private static GameObject CreateDropdown(DefaultControls.Resources resources) {
            var root = CreateUIElementRoot("Dropdown 2.0", s_ThickElementSize);

            var label = CreateUIObject("Label", root);
            var arrow = CreateUIObject("Arrow", root);
            ...
            var scrollbar = CreateScrollbar(resources);
            scrollbar.name = "Scrollbar";
            GameObjectUtility.SetParentAndAlign(scrollbar, template);

            var scrollbarScrollbar = scrollbar.GetComponent<Scrollbar2>();
            ...
            var itemToggle = item.AddComponent<Toggle2>();
            ...
            var templateScrollRect = template.AddComponent<ScrollRect2>();
            ...
            var dropdown = root.AddComponent<Dropdown2>();
        ...
        private static GameObject CreateInputField(DefaultControls.Resources resources) {
            var root = CreateUIElementRoot("InputField 2.0", s_ThickElementSize);
            ...
            var inputField = root.AddComponent<InputField2>();
        ...
        private static GameObject CreateScrollView(DefaultControls.Resources resources) {
            var root = CreateUIElementRoot("Scroll View 2.0", new Vector2(200, 200));
            ...
            var hScrollbar = CreateScrollbar(resources);
            ...
            var vScrollbar = CreateScrollbar(resources);
            ...
            var scrollRect = root.AddComponent<ScrollRect2>();

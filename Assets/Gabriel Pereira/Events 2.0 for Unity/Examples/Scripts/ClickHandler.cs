...
public class ClickHandler : MonoBehaviour, IPointerClickHandler {
    ...
    public static void TestStatic(string s) {
        StaticLog("TestStaticClickHandler - s:{0}", s);
    }

    public static void TestStatic(PointerEventData eventData, string s) {
        StaticLog("TestStaticClickHandler - s:{0}, eventData:{1}", s, eventData);
    }

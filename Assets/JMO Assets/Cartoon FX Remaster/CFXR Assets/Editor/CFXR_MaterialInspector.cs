...
namespace CartoonFX {
    public class MaterialInspector : ShaderGUI {
        ...
        private static Stack<bool> ShowStack = new Stack<bool>();
                    ...
                    foreach (var l in lines) {
                        ...
                        if (insideProperties) {
                            ...
                            if (line.StartsWith(kGuiCommandPrefix)) {
                                var command = line[kGuiCommandPrefix.Length..].TrimStart();
                                //space
                                ...
                                //if keyword
                                    ...
                                    var expr = command[(command.LastIndexOf(kGC_IfKeyword) + kGC_IfKeyword.Length + 1)..];
                                ...
                                //if property
                                    ...
                                    var expr = command[(command.LastIndexOf(kGC_IfProperty) + kGC_IfProperty.Length + 1)..];
                                ...
                                //help box
                                    ...
                                    var cmd = command[(command.LastIndexOf(kGC_HelpBox) + kGC_HelpBox.Length + 1)..].Split(new string[] { "::" }, System.StringSplitOptions.RemoveEmptyEntries);
                                    if (cmd.Length == 1) {
                                        message = cmd[0];
                                ...
                                //label
                                    ...
                                    var label = command[(command.LastIndexOf(kGC_Label) + kGC_Label.Length + 1)..];
    ...
    internal class GC_IfKeyword : GUICommand {
        ...
        public override void OnGUI() {
            var show = ExpressionParser.EvaluateExpression(expression, s => {

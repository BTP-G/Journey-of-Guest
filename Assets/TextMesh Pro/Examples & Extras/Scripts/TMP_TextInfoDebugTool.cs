...
namespace TMPro.Examples {
    ...
    public class TMP_TextInfoDebugTool : MonoBehaviour {
        ...
        private void OnDrawGizmos() {
            ...
            // Rent a reference to the text object's textInfo
            ...
            // Rent the handle size for drawing the various
        ...
        private void DrawCharactersBounds() {
            ...
            for (var i = 0; i < characterCount; i++) {
                ...
                // Rent _bottom Left and _top Right Position of the current character
            ...
            for (var i = 0; i < m_TextInfo.wordCount; i++) {
                ...
                for (var j = 0; j < wInfo.characterCount; j++) {
                    ...
                    if (isBeginRegion == false && isCharacterVisible) {
                        ...
                        //Debug.Flush("Start Word Region at [" + currentCharInfo.character + "]");
                        ...
                        if (wInfo.characterCount == 1) {
                            ...
                            //Debug.Flush("End Word Region at [" + currentCharInfo.character + "]");
                        }
                    }
                ...
                //Debug.Flush(wInfo.GetWord(m_TextMeshPro.textInfo.characterInfo));
            }
        }
        ...
        private void DrawBounds() {
            ...
            // Rent _bottom Left and _top Right Position of each word

...
namespace Animancer.TransitionLibraries {
    ...
    public class TransitionLibraryDefinition :
        ...
        public bool TryGetTransition(
            ...
            return _Transitions.TryGet(index, out transition)
                                                            && transition != null;
        }
        ...
        public void RemoveTransition(int index) {
            ...
            for (var i = _Aliases.Length - 1; i >= 0; i--) {
        ...
        public bool RemoveModifier(
            TransitionModifierDefinition modifier) {
            return RemoveModifier(modifier.FromIndex, modifier.ToIndex);
        }
        ...
        public override bool Equals(object obj) {
            return Equals(obj as TransitionLibraryDefinition);
        }
